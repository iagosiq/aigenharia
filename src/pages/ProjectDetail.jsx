        ...
        <Paper sx={{ p: 4, mb: 4, backgroundColor: "#14103400" }}>
          ...
          <Box sx={{ mt: 2 }}>
            ...
            <TextField
              ...
              fullWidth
              value={convStructure}
              onChange={(e) => setConvStructure(e.target.value)}
              label="Selecione"
              variant="outlined"
            >
          ...
          <Box sx={{ mt: 2 }}>
            <TextField
              fullWidth
              value={convPage}
              onChange={(e) => setConvPage(e.target.value)}
          ...
          <Box sx={{ mt: 2 }}>
            <TextField
              ...
              fullWidth
              value={convMultiple}
              onChange={(e) => setConvMultiple(e.target.value)}
          ...
          <Box sx={{ mt: 2 }}>
            <TextField
              ...
              minRows={3}
              value={convDetail}
              onChange={(e) => setConvDetail(e.target.value)}
